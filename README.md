 ...
 * node: 16
 * [@chubbyts/chubbyts-dic][2]: ^1.1.1
 * [@chubbyts/chubbyts-dic-config][3]: ^1.1.1
 * [@chubbyts/chubbyts-dic-types][4]: ^1.1.1
 * [@chubbyts/chubbyts-framework][5]: ^1.8.1
 * [@chubbyts/chubbyts-framework-router-path-to-regexp][6]: ^1.3.1
 * [@chubbyts/chubbyts-http][7]: ^1.1.1
 * [@chubbyts/chubbyts-http-types][8]: ^1.1.1
 * [@chubbyts/chubbyts-log-types][9]: ^1.2.1
 * [@chubbyts/chubbyts-node-http-bridge][10]: ^1.1.1
 * [@chubbyts/chubbyts-pino-adapter][11]: ^1.2.1
 * [commander][12]: ^11.0.0
 * [pino][13]: ^8.14.1
